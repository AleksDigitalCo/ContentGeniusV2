...
// Import models and plugins from the Google AI plugin. The Google AI API
...
// function creates a callable function from a Genkit action. It
// automatically implements streaming if your flow does.
